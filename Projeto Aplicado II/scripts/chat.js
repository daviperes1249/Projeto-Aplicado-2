...
const perguntasRespostas = {
  ...
  "No que vc pode me auxiliar?": "Eu posso falar pra você quais caminhões estão liberados, quais caminhoneiros estã disponives para trabalho e muito mais!",
  ...
  "Quantos caminhões estão disponiveis para viagem?": "Cinco caminhões estão diponiveis(ARRUMAR)",
  "Tem algum caminhão na oficina?": "Atualmente dois caminhões estão na oficina.(ARRUMAR)",
  "Quantos caminhões estão em viagem atualmente?": "Atualmente quatro caminhões estão em viagem.",
  "Quais são os tipos de caminhões disponíveis para viagem?": "Os tipos de caminhões são scania 500(BOTAR MAIS)",
  "Quais são as regiões em que os motoristas estão passando atualmente?": "Região sul de Santa Catarina",
  "Quais caminhões estarão disponiveis para viagem amanhã?": "(BOTAR)",
  "Quais são os horários de trabalho dos motoristas disponíveis?": "Os horarios são esses(BOTARR).",
